              ...
              <div className="spacer">
                ...
                {username ? (
                  <>
                    ...
                    <Link className="logout-link" onClick={handleLogout}>Sign out</Link>
                    <div style={{ width: "200px" }} />
                  </>
                ) : (
                  <div>
                    <Link className="header-link" to="#" onClick={toggleLoginForm}>Sign in</Link>
                    <span>/</span>
                    <Link className="header-link" to="#" onClick={toggleRegisterForm}>Sign up</Link>
